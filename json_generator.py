...
This file is part of platform-weidos-esp32.
...
This module defines a data class, JSON_PLC, to represent a generic Weidmuller Weidos PLC that is
...
class JSON_PLC:
    """
    Represents a PlatformIO configuration for an Weidmuller Weidos PLC, in JSON format.
    """
